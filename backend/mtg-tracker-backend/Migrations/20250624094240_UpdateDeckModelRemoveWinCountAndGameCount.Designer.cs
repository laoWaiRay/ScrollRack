...
namespace Mtg_tracker.Migrations
{
    ...
    [Migration("20250624094240_UpdateDeckModelRemoveWinCountAndGameCount")]
    partial class UpdateDeckModelRemoveWinCountAndGameCount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mtg_tracker.Models.Game", b =>
                {
                    ...
                    b.HasIndex("CreatedByUserId")
                        .HasDatabaseName("ix_games_created_by_user_id");
            ...
            modelBuilder.Entity("Mtg_tracker.Models.Game", b =>
                {
                    b.HasOne("Mtg_tracker.Models.ApplicationUser", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_games_asp_net_users_created_by_user_id");
