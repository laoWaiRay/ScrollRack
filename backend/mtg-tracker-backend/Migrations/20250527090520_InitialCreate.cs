...
namespace Mtg_tracker.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "application_user_application_user",
                columns: table => new
                {
                    application_user_id = table.Column<string>(type: "text", nullable: false),
                    friends_id = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_application_user_application_user", x => new { x.application_user_id, x.friends_id });
                    table.ForeignKey(
                        name: "fk_application_user_application_user_asp_net_users_application_u",
                        column: x => x.application_user_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_application_user_application_user_asp_net_users_friends_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    moxfield = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_friend_requests_asp_net_users_receiver_id",
                        column: x => x.receiver_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_friend_requests_asp_net_users_sender_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_game_participations", x => x.id);
                    table.ForeignKey(
                        name: "fk_game_participations_decks_deck_id",
                        column: x => x.deck_id,
                        principalTable: "decks",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_game_participations_games_game_id",
                        column: x => x.game_id,
                        principalTable: "games",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_game_participations_users_user_id",
                        column: x => x.user_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_application_user_application_user_friends_id",
                table: "application_user_application_user",
                column: "friends_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_game_participations_game_id",
                table: "game_participations",
                column: "game_id");

            migrationBuilder.CreateIndex(
                name: "ix_game_participations_user_id",
                table: "game_participations",
                column: "user_id");
